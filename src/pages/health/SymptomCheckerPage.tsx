  ...
  return (
    <div className="min-h-screen bg-[#FEFCF3] pb-20 font-inter relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 max-w-6xl mx-auto">
          ...
          >
            <Button
              ...
              className="hover:bg-[#296CBC10] min-w-[44px] min-h-[44px] rounded-xl"
            >
      ...
      <div className="absolute inset-0 opacity-5 sm:opacity-10 pointer-events-none">
        <motion.div 
          className="absolute top-20 left-8 w-20 h-20 sm:w-32 sm:h-32 bg-gradient-to-br from-[#296CBC] to-[#296CBC] rounded-full blur-2xl" 
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.3, 0.7, 0.3],
            rotate: [0, 90, 0]
        ...
        />
        <motion.div 
          className="absolute bottom-32 right-8 w-24 h-24 sm:w-36 sm:h-36 bg-gradient-to-br from-[#296CBC] to-[#F6E05E] rounded-full blur-2xl"
          animate={{
            scale: [1, 1.2, 1],
            x: [0, 15, 0],
            y: [0, -10, 0],
        ...
        />
        <motion.div 
          className="absolute top-1/2 left-1/4 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-[#296CBC] to-[#296CBC] rounded-full blur-xl"
          animate={{
            scale: [1, 1.4, 1],
            rotate: [0, -90, 0],
            opacity: [0.2, 0.6, 0.2]
            ...
            >
              ...
              <div className="grid gap-4 text-base sm:text-lg text-[#4A5568] font-inter">
                <div className="flex items-start gap-4">
                  <span className="flex-shrink-0 w-8 h-8 bg-[#296CBC20] rounded-full flex items-center justify-center text-sm font-bold text-[#296CBC]">1</span>
                  <span>Describe your symptoms in detail using voice or text</span>
                </div>
                <div className="flex items-start gap-4">
                  <span className="flex-shrink-0 w-8 h-8 bg-[#296CBC20] rounded-full flex items-center justify-center text-sm font-bold text-[#296CBC]">2</span>
                  <span>AI analyzes your input for possible conditions</span>
                </div>
                <div className="flex items-start gap-4">
                  <span className="flex-shrink-0 w-8 h-8 bg-[#296CBC20] rounded-full flex items-center justify-center text-sm font-bold text-[#296CBC]">3</span>
