...
const VaccineTrackerPage = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "given": return "bg-[#296CBC] text-white";
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      case "given": return <CheckCircle className="w-4 h-4 text-[#296CBC]" />;
    ...
    <div className="min-h-screen bg-[#FEFCF3] pb-20 font-inter">
      ...
      >
        <div className="flex items-center gap-3 max-w-4xl mx-auto">
          <Button variant="ghost" size="sm" onClick={() => navigate("/health")} className="hover:bg-[#296CBC10]">
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <Button
              ...
              className="bg-[#296CBC] hover:bg-[#296CBC]/90 text-white"
              size="sm"
            >
      ...
      <main className="px-4 py-6 max-w-4xl mx-auto space-y-6">
            ...
            <Card className="bg-white border border-[#E2E8F0]">
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  <Users className="w-5 h-5 text-[#296CBC]" />
                ...
                <Card className="bg-white border border-[#E2E8F0]">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                      <Baby className="w-5 h-5 text-[#296CBC]" />
                      Add New Child
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="border-[#E2E8F0] focus:border-[#296CBC] focus:ring-[#296CBC]"
                      />
                    </div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button 
                        ...
                        className="flex-1 bg-[#296CBC] hover:bg-[#296CBC]/90 text-white font-semibold"
                      >
                        Add Child
                      </Button>
                    </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              ...
              <TabsContent value="overview" className="space-y-6">
                ...
                <Card className="bg-white border border-[#E2E8F0]">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                      <TrendingUp className="w-5 h-5 text-[#296CBC]" />
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-bold text-[#296CBC]">{getVaccinationProgress(getSelectedChild()!)}%</span>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-4">
                      <div className="text-center p-3 bg-[#F8F5F0] rounded-lg">
                        <div className="text-lg font-bold text-[#296CBC]">
                ...
                <Card className="bg-white border border-[#E2E8F0]">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                      <Clock className="w-5 h-5 text-[#296CBC]" />
                      Upcoming Vaccines
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              <TabsContent value="vaccines" className="space-y-6">
                ...
                <Card className="bg-white border border-[#E2E8F0]">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                      <Shield className="w-5 h-5 text-[#296CBC]" />
                      Vaccine Schedule
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                        ...
                        <div key={index} className="flex items-center justify-between p-3 bg-[#F8F5F0] rounded-lg">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              {vaccine.givenDate && (
                                <p className="text-xs text-[#296CBC] font-inter">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {(vaccine.status === "pending" || vaccine.status === "overdue" || vaccine.status === "upcoming") && (
                              <Button
                                ...
                                className="bg-[#296CBC] hover:bg-[#296CBC]/90 text-white text-xs"
                              >
                                Mark Given
                              </Button>
                            )}
              ...
              <TabsContent value="reminders" className="space-y-6">
                <Card className="bg-white border border-[#E2E8F0]">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                      <Bell className="w-5 h-5 text-[#296CBC]" />
                      Active Reminders
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
        ...
        {children.length === 0 && (
          ...
          >
            <Baby className="w-16 h-16 text-[#296CBC] mx-auto mb-4" />
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        className="border-[#E2E8F0] focus:border-[#296CBC] focus:ring-[#296CBC] min-h-[80px]"
                      />
                    </div>
