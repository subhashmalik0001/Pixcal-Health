        ...
        >
          ...
          {analysis && (
            <Card className="bg-white border border-[#E2E8F0]">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                  <Activity className="w-5 h-5 text-[#296CBC]" />
                  Sleep Analysis
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#296CBC] mb-2 font-nunito">{analysis.sleepScore}/100</div>
                  <Badge variant={analysis.sleepScore >= 80 ? "default" : analysis.sleepScore >= 60 ? "secondary" : "destructive"} className="bg-[#296CBC] text-white">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-[#296CBC] font-nunito">{analysis.sleepPhases.deep}h</div>
                  ...
                  <div className="space-y-2">
                    {analysis.recommendations?.map((rec, index) => (
                      <div key={index} className="flex items-start gap-3 p-3 bg-[#F8F5F0] rounded-lg">
                        <div className="w-6 h-6 bg-[#296CBC20] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                          <span className="text-xs font-bold text-[#296CBC]">{index + 1}</span>
                        </div>
