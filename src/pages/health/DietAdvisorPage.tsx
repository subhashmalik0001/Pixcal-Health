      ...
      <main className="px-4 py-6 max-w-6xl mx-auto space-y-6">
        ...
        >
          <Button
            ...
            className={activeTab === 'profile' ? 'bg-[#296CBC] text-white' : 'text-[#4A5568]'}
          >
          ...
          <Button
            ...
            className={activeTab === 'scan' ? 'bg-[#296CBC] text-white' : 'text-[#4A5568]'}
          >
          ...
          <Button
            ...
            className={activeTab === 'progress' ? 'bg-[#296CBC] text-white' : 'text-[#4A5568]'}
          >
        ...
        {activeTab === 'profile' && (
          ...
          <Card className="bg-white border border-[#E2E8F0]">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                <Target className="w-5 h-5 text-[#296CBC]" />
                Your Profile
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Select value={profile.activity} onValueChange={(value) => setProfile({...profile, activity: value})}>
                  <SelectTrigger className="border-[#E2E8F0] focus:border-[#296CBC] focus:ring-[#296CBC]">
          ...
          {mealPlan && (
            <Card className="bg-white border border-[#E2E8F0]">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                  <Utensils className="w-5 h-5 text-[#296CBC]" />
                  Your Meal Plan
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center p-4 bg-[#F8F5F0] rounded-lg">
                  <div className="text-2xl font-bold text-[#296CBC] font-nunito mb-1">{mealPlan.dailyCalories}</div>
        ...
        {activeTab === 'scan' && (
          ...
          >
            <Card className="bg-white border border-[#E2E8F0]">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                  <Camera className="w-5 h-5 text-[#296CBC]" />
                  Food Scanner
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                {imagePreview && (
                  <div className="space-y-4">
                    ...
                    <Button
                      ...
                      className="w-full bg-[#296CBC] hover:bg-[#296CBC]/90"
                    >
                      {isAnalyzing ? (
                        <>
            ...
            {foodAnalysis && (
              <Card className="bg-white border border-[#E2E8F0]">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                    <BarChart3 className="w-5 h-5 text-[#296CBC]" />
                    Food Analysis
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="text-center p-4 bg-[#F8F5F0] rounded-lg">
                    ...
                    <div className="text-2xl font-bold text-[#296CBC] mb-1">{foodAnalysis.calories}</div>
        ...
        {activeTab === 'progress' && weeklyProgress && (
          ...
          >
            <Card className="bg-white border border-[#E2E8F0]">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg font-bold text-[#2D3748] font-nunito">
                  <Calendar className="w-5 h-5 text-[#296CBC]" />
                  Weekly Progress
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-[#F8F5F0] rounded-lg text-center">
                    <div className="text-2xl font-bold text-[#296CBC] mb-1">{weeklyProgress.avgCalories}</div>
