...
const TOOL_COLOR_MAP = {
  ...
  'sleep-analyzer': { color: '#296CBC', bg: '#296CBC20' }, // Sleep Analyzer
  'diet-advisor': { color: '#F6E05E', bg: '#F6E05E20' }, // NutriGuide
  'child-tracker': { color: '#3182CE', bg: '#3182CE20' }, // Child Vaccine Tracker
  'cognitive-screener': { color: '#296CBC', bg: '#296CBC20' }, // Cognitive Health Screener
            ...
            <CardContent>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 tools-grid">
                {filteredTools.map((tool, index) => {
                  const colorInfo = TOOL_COLOR_MAP[tool.id] || { color: '#296CBC', bg: '#296CBC20' };
                  return (
                    <motion.div
                      key={tool.id}
                        ...
                        <CardContent className="p-4 space-y-3 h-full flex flex-col">
                          ...
                          <div className="flex items-start justify-between">
                            ...
                            <div className="flex flex-col items-end gap-1">
                              <Badge 
                                variant="default"
                                className="text-xs bg-[#296CBC] text-white"
                              >
                                Available
                              </Badge>
                          ...
                          <div className="pt-2 border-t border-[#E2E8F0]">
                            <Button 
                              variant="ghost" 
                              size="sm" 
                              className="w-full text-xs bg-[#F8F5F0] hover:bg-[#296CBC20] text-[#2D3748] font-semibold"
                            >
                              Launch Tool
                            </Button>
                          </div>
