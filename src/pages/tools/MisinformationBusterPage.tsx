              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <Textarea
                    ...
                    className="min-h-[120px] resize-none border-[#E2E8F0] focus:border-[#296CBC] focus:ring-[#296CBC]"
          ...
          {result && (
            ...
            >
                  ...
                  <div className="flex items-center gap-3 p-4 bg-[#F8F5F0] rounded-xl">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-sm font-bold text-[#296CBC]">{result.confidence}%</span>
                      </div>
              ...
              <Card className="bg-white border border-[#E2E8F0]">
                <CardHeader className="pb-3">
                  <CardTitle className="text-lg font-bold text-[#2D3748] font-nunito flex items-center gap-2">
                    <ExternalLink className="w-5 h-5 text-[#296CBC]" />
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    {TRUSTED_SOURCES.map((source) => (
                      <a
                        ...
                        className="flex items-center gap-3 p-3 bg-[#F8F5F0] rounded-lg hover:bg-[#296CBC10] transition-colors"
                      >
                        <ExternalLink className="w-4 h-4 text-[#296CBC]" />
                        <div>
